...
class MoneyTransferTest {
    ...
    void shouldTransferMoneyFromFirstToSecondCards() {
        ...
        var amount1 = DataHelper.dicreaseBalance(dashboardBefore.getCardBalance(getFirstCard()), transferAmount);
    ...
    void shouldTransferMoneyFromSecondToFirstCards() {
        ...
        var dashboardBefore = new LoginPage()
                .validLogin(getAuthInfo())
                .validVerify(getVerificationCodeFor(getAuthInfo()));
        var amount1 = DataHelper.dicreaseBalance(dashboardBefore.getCardBalance(getSecondCard()), transferAmount);
